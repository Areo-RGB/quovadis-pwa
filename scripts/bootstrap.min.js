  ...
  var U = (function () {
      ...
      return (
        ...
        (u.on = function (t, n, e, i) {
          return (
            void 0 === e && (e = null), void 0 === i && (i = {}), this.Event.on(t, n, e, i), this
          );
        }),
        (u.off = function (t, n) {
    ...
    it = function (t, n) {
      ...
      function a() {
        ...
        return (
          r && (e = Math.ceil(o.track['client' + i] / r)), e * (n.drag ? n.flickMaxPages + 1 : 1)
        );
      }
      function u(n) {
        var e = n.cloneNode(!0);
        ...
        function c(n) {
          (n = isNaN(n) ? t.index : n),
            (r = r.filter(function (t) {
              return (
                !t.Slide.isWithin(n, s.perPage * (s.preloadPages + 1)) || (d(t.img, t.Slide), !1)
              );
            }))[0] || t.off('moved.' + e);
        }
        function d(n, e) {
