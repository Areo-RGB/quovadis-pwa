...
!(function (t, e) {
  ...
  var a = new (class {
    ...
    _notify(t, e, i, n) {
      const o = e.listeners[n],
        s = e.duration;
      o.forEach(n =>
        n({ chart: t, initial: e.initial, numSteps: s, currentStep: Math.min(i - e.start, s) })
      );
    }
    _refresh() {
      const e = this;
    ...
    _update(t = Date.now()) {
      ...
      e._charts.forEach((n, o) => {
        ...
        l && (o.draw(), e._notify(o, n, t, 'progress')),
          s.length || ((n.running = !1), e._notify(o, n, t, 'complete'), (n.initial = !1)),
          (i += s.length);
      }),
        (e._lastDate = t),
        0 === i && (e._running = !1);
  ...
  function Gt(t, e, i) {
    return (
      (i = i || 0.5),
      t && e && t.x > e.left - i && t.x < e.right + i && t.y > e.top - i && t.y < e.bottom + i
    );
  }
  function Zt(t, e) {
  ...
  function ei(t, e = [''], i = t, n, o = () => t[0]) {
    ...
    return new Proxy(s, {
      ...
      ownKeys: t => fi(t),
      set: (t, e, i) => (
        ((t._storage || (t._storage = o()))[e] = i), delete t[e], delete t._keys, !0
      ),
    });
  }
  function ii(t, e, i, n) {
    ...
    !(function (t, e, i) {
      ...
      (function (t, e, i = 'x') {
        ...
        for (let c = 0; c < o; ++c) {
          ...
          const o = r[i],
            h = r[n];
          a && ((s = (o - a[i]) / 3), (r[`cp1${i}`] = o - s), (r[`cp1${n}`] = h - s * e[c])),
            l && ((s = (l[i] - o) / 3), (r[`cp2${i}`] = o + s), (r[`cp2${n}`] = h + s * e[c]));
        }
      })(t, s, e);
  }
  function _i(t, e, i) {
      ...
      (function (t, e) {
        ...
        for (i = 0, n = t.length; i < n; ++i)
          (a = s),
            ...
            s &&
              ((o = t[i]),
              a && ((o.cp1x = _i(o.cp1x, e.left, e.right)), (o.cp1y = _i(o.cp1y, e.top, e.bottom))),
              r &&
                ((o.cp2x = _i(o.cp2x, e.left, e.right)), (o.cp2y = _i(o.cp2y, e.top, e.bottom))));
      })(t, i);
  }
  const vi = t => 0 === t || 1 === t,
    ...
    ki = {
      ...
      easeInOutElastic(t) {
        const e = 0.1125;
        return vi(t) ? t : t < 0.5 ? 0.5 * wi(2 * t, e, 0.45) : 0.5 + 0.5 * Mi(2 * t - 1, e, 0.45);
      },
      easeInBack(t) {
        const e = 1.70158;
        return t * t * ((e + 1) * t - e);
      ...
      easeInOutBounce: t =>
        t < 0.5 ? 0.5 * ki.easeInBounce(2 * t) : 0.5 * ki.easeOutBounce(2 * t - 1) + 0.5,
    };
  function Si(t, e, i, n) {
          ...
          for (const c of e) {
            ...
            for (l = r + 1; l <= c.end; l++) {
              ...
              (e = Vi(
                ...
                Wi(e, h) &&
                  (a.push({ start: r, end: l - 1, loop: c.loop, style: h }), (h = e), (r = l - 1)),
                (d = o),
                (h = e);
            }
  ...
  function on(t) {
    return !ue() || ('undefined' != typeof OffscreenCanvas && t instanceof OffscreenCanvas)
      ? ji
      : nn;
  }
  ...
  class En extends Mn {
    ...
    _convertTicksToLabels(t) {
      ...
      let i, n;
      for (
        e.beforeTickToLabelConversion(), e.generateTickLabels(t), i = 0, n = t.length;
        i < n;
        i++
      )
    ...
    _computeGridLineItems(t) {
      ...
      if ('top' === a)
        (m = p(e.bottom)), (v = e.bottom - h), (M = m - g), (S = p(t.top) + g), (D = t.bottom);
      else if ('bottom' === a)
        (m = p(e.top)), (S = t.top), (D = p(t.bottom) - g), (v = m + g), (M = e.top + h);
      else if ('left' === a)
        (m = p(e.right)), (y = e.right - h), (w = m - g), (k = p(t.left) + g), (P = t.right);
      else if ('right' === a)
        (m = p(e.left)), (k = t.left), (P = p(t.right) - g), (y = m + g), (w = e.left + h);
      else if ('x' === i) {
    ...
    drawBorder() {
      ...
      let l, c, h, d;
      t.isHorizontal()
        ? ((l = Xt(e, t.left, s) - s / 2), (c = Xt(e, t.right, a) + a / 2), (h = d = r))
        : ((h = Xt(e, t.top, s) - s / 2), (d = Xt(e, t.bottom, a) + a / 2), (l = c = r)),
        i.save(),
  ...
  function eo(t) {
    return (
      ue() && 'string' == typeof t ? (t = document.getElementById(t)) : t && t.length && (t = t[0]),
  ...
  class oo {
      ...
      i &&
        ...
        J(s, i => {
          ...
          if (a in n && n[a].type === l) c = n[a];
            ...
            (c = new (zn.getScale(l))({ id: a, type: l, ctx: t.ctx, chart: t })), (n[c.id] = c);
          }
          c.init(s, e);
        }),
        J(o, (t, e) => {
    ...
    render() {
      ...
      !1 !== t.notifyPlugins('beforeRender', { cancelable: !0 }) &&
        (a.has(t) ? t.attached && !a.running(t) && a.start(t) : (t.draw(), Jn({ chart: t })));
    }
    draw() {
      const t = this;
      let e;
    ...
    _eventHandler(t, e) {
      ...
      return (
        (n.cancelable = !1), i.notifyPlugins('afterEvent', n, o), (s || n.changed) && i.render(), i
      );
    }
    _handleEvent(t, e) {
      const i = this,
  ...
  Object.defineProperties(oo, {
    ...
    version: { enumerable: ao, value: '3.5.0' },
  ...
  function mo(t, e, i, n) {
    ...
    return (
      n
        ? ((a = i), (t = xo((t = (o = t) === (s = e) ? a : o === a ? s : o), i, e)))
        : (t = xo(t, e, i)),
      t
    );
  }
  ...
  class bo extends wn {
    ...
    _calculateBarIndexPixels(t, e) {
      ...
      if (e.grouped) {
        ...
        (r = n.getPixelForValue(i.getParsed(t)[n.axis], t)), (l = Math.min(a, e.min * e.ratio));
    ...
    updateElements(t, e, i, n) {
      ...
      for (let l = e; l < e + i; l++) {
        ...
        (c.skip = isNaN(f) || isNaN(g)),
          h &&
            ((c.options = o.resolveDataElementOptions(l, e.active ? 'active' : n)),
  ...
  (yo.id = 'doughnut'),
    ...
    (yo.descriptors = { _scriptable: t => 'spacing' !== t, _indexable: t => 'spacing' !== t }),
    (yo.overrides = {
      aspectRatio: 1,
      plugins: {
        legend: {
    ...
    update(t) {
      ...
      let { start: r, count: l } = (function (t, e, i) {
        ...
        if (t._sorted) {
          ...
          d &&
            (o = Ht(
              Math.min(se(r, a.axis, c).lo, i ? n : se(e, l, a.getPixelForValue(c)).lo),
              0,
              n - 1
            )),
            (s = u
              ? Ht(
                  Math.max(se(r, a.axis, h).hi + 1, i ? 0 : se(e, l, a.getPixelForValue(h)).hi + 1),
                  o,
                  n
                ) - o
              : n - o);
    ...
    updateElements(t, e, i, n) {
      ...
      for (let c = e; c < e + i; ++c) {
        const e = t[c],
          ...
          y = (g[f] =
            s || b ? r.getBasePixel() : r.getPixelForValue(l ? o.applyStack(r, i, l) : i[f], c));
  ...
  (vo.id = 'line'),
    ...
    (vo.overrides = { scales: { _index_: { type: 'category' }, _value_: { type: 'linear' } } });
  class wo extends wn {
    constructor(t, e) {
  ...
  (ko.id = 'radar'),
    ...
    (ko.overrides = { aspectRatio: 1, scales: { r: { type: 'radialLinear' } } });
  class So extends vo {}
  (So.id = 'scatter'),
  ...
  function Do(t, e, i) {
    ...
    t.beginPath(),
      t.arc(s, a, r, n - c, i + c),
      l > o ? ((c = o / l), t.arc(s, a, l, i + c, n - c, !0)) : t.arc(s, a, o, i + Mt, n - Mt),
      t.closePath(),
      t.clip();
  }
  function Co(t, e, i, n) {
    ...
    s.borderWidth &&
      ...
      e.fullCircles &&
        (function (t, e, i) {
          ...
          let h;
          for (
            i && Do(t, e, s + _t), t.beginPath(), t.arc(n, o, c, s + _t, s, !0), h = 0;
            h < r;
            ++h
          )
            t.stroke();
  ...
  (jo.id = 'point'),
    ...
    (jo.defaultRoutes = { backgroundColor: 'backgroundColor', borderColor: 'borderColor' });
  class Go extends Mn {
    constructor(t) {
      super(),
        (this.options = void 0),
            ...
            u = (function (t, e, i, n, o) {
              ...
              for (a[l++] = t[p], h = 0; h < s - 2; h++) {
                ...
                const b = Math.floor(h * r) + 1 + e,
                  ...
                  { x: y, y: v } = t[p];
                for (u = f = -1, n = b; n < _; n++)
                  (f = 0.5 * Math.abs((y - o) * (t[n].y - v) - (y - t[n].x) * (s - v))),
                    f > u && ((u = f), (d = t[n]), (g = n));
                (a[l++] = d), (p = g);
              }
              return (a[l++] = t[c]), a;
  ...
  class is {
    ...
    pathSegment(t, e, i) {
      ...
      return (e = e || { start: 0, end: _t }), t.arc(n, o, s, e.end, e.start, !0), !i.bounds;
    }
    interpolate(t) {
      ...
      ? (function (t) {
          ...
          if (
            ...
            return (
              ...
              new is({ x: c.x, y: c.y, radius: e.getDistanceFromCenterForValue(h) })
            );
            ...
            return (
              e.segments.forEach(({ start: t, end: e }) => {
                ...
                null !== n
                  ...
                  : null !== i && (s.push({ x: i, y: a.y }), s.push({ x: i, y: r.y }));
              }),
              s
            );
          })(t, e)),
      i.length ? new No({ points: i, options: { tension: 0 }, _loop: n, _fullLoop: n }) : null
    );
  }
  function hs(t, e, i) {
    let n = t[e].fill;
    ...
    n &&
      ...
      (function (t, e) {
        ...
        t.save(),
          ...
          t.restore();
      })(t, { line: o, target: n, above: h, below: d, area: i, scale: s, axis: a }),
      Qt(t));
  }
  var bs = {
    id: 'filler',
  ...
  class ys extends Mn {
    ...
    adjustHitBoxes() {
      ...
      if (this.isHorizontal()) {
        ...
        for (const c of i)
          a !== c.row && ((a = c.row), (l = o(n, t.left + s, t.right - t.lineWidths[a]))),
            (c.top += t.top + e + s),
        ...
        for (const c of i)
          c.col !== a &&
            ((a = c.col), (l = o(n, t.top + e + s, t.bottom - t.columnSizes[a].height))),
            (c.top = l),
            (c.left += t.left + s),
      ...
      t.legendItems.forEach((M, k) => {
        ...
        h.setWidth(t.width),
          y
            ? k > 0 &&
              C + D + f > t.right &&
              ((O = m.y += w), m.line++, (C = m.x = o(r, t.left + f, t.right - n[m.line])))
            : k > 0 &&
              O + w > t.bottom &&
  ...
  class js extends En {
    ...
    handleTickRangeOptions() {
      ...
      if (o === s) {
        let t = 1;
        (s >= Number.MAX_SAFE_INTEGER || o <= Number.MIN_SAFE_INTEGER) && (t = Math.abs(0.05 * s)),
          r(s + t),
          e || a(o - t);
      }
      (t.min = o), (t.max = s);
      ...
      const o = (function (t, e) {
        ...
        (M = Math.ceil(p / k) - Math.floor(g / k)),
          ...
          m && x && o && Lt((a - s) / o, k / 1e3)
            ? ((M = Math.round(Math.min((a - s) / k, c))), (k = (a - s) / M), (v = s), (w = a))
            : b
  ...
  class Us extends En {
    ...
    getPixelForValue(t) {
      ...
      return (
        ...
        null === t || isNaN(t)
          ? NaN
          : e.getPixelForDecimal(t === e.min ? 0 : (Pt(t) - e._startValue) / e._valueRange)
      );
    }
    getValueForPixel(t) {
      const e = this,
  ...
  (Us.id = 'logarithmic'),
    (Us.defaults = { ticks: { callback: Sn.formatters.logarithmic, major: { enabled: !0 } } });
  class ea extends js {
    constructor(t) {
      super(t),
        (this.xCenter = void 0),
    ...
    getPointLabelContext(t) {
      ...
      if (t >= 0 && t < i.length) {
        ...
        return (function (t, e, i) {
          return Object.assign(Object.create(t), { label: i, index: e, type: 'pointLabel' });
        })(e.getContext(), t, n);
      }
    }
  ...
  function sa(t, e) {
    ...
    return (
      ...
      null === a
        ...
        : (o &&
            (a =
              'week' !== o || (!Tt(s) && !0 !== s) ? i.startOf(a, o) : i.startOf(a, 'isoWeek', s)),
          +a)
    );
  }
  function aa(t, e, i, n) {
  ...
  function ha(t, e, i) {
    ...
    i
      ? (e >= t[r].pos && e <= t[l].pos && ({ lo: r, hi: l } = se(t, 'pos', e)),
        ({ pos: n, time: s } = t[r]),
        ({ pos: o, time: a } = t[l]))
      : (e >= t[r].time && e <= t[l].time && ({ lo: r, hi: l } = se(t, 'time', e)),
        ({ time: n, pos: s } = t[r]),
        ({ time: o, pos: a } = t[l]));
    const c = o - n;
