function beforeAfter() {
  ...
  var beforeMediaBA =
    beforeBA.getElementsByTagName('img')[0] || beforeBA.getElementsByTagName('video')[0];
  var afterMediaBA =
    afterBA.getElementsByTagName('img')[0] || afterBA.getElementsByTagName('video')[0];
...
function initVideoControls() {
  ...
  function setPlaybackSpeed(speed) {
    ...
    var activeBtn = document.getElementById('speed-' + speed.toString().replace('.', ''));
    if (activeBtn) {
