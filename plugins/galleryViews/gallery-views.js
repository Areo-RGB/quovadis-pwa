...
function galleryViews() {
  ...
  function removeSelected(el) {
    ...
    for (var i = 0; i < galleryViewControls.length; i++) {
      galleryViewControls[i].classList.remove(galleryColorClass);
    }
    for (var i = 0; i < galleryViews.length; i++) {
      galleryViews[i].removeAttribute('class');
